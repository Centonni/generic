...
public class GenericApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(GenericApp.class);

    private final Environment env;

    public GenericApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GenericApp.class);
